...
{{--                <div class="brand-logo"><img class="img-fluid" src="{{URL::to('/')}}/img/custom/logo.svg" alt="App Logo" style="width: auto; max-width: 100%; height: 35px;"></div>--}}
{{--                <div class="brand-logo-collapsed"><img class="img-fluid" src="img/logo-single.png" alt="App Logo"></div>--}}
                <div class="brand-logo"><span class="text-uppercase text-light">Mals</span></div>
                <div class="brand-logo-collapsed"><span class="text-uppercase text-light">M</span></div>
        ...
        <ul class="navbar-nav mr-auto flex-row">
            ...
            <li class="nav-item d-none d-md-block">
                <!-- Button used to collapse the left sidebar. Only visible on tablet and desktops--><a class="nav-link d-none" id="user-block-toggle" href="#user-block" data-toggle="collapse"><em class="icon-user"></em></a>
...
{{--            </li><!-- END Alert menu-->--}}
            ...
            <li class="nav-item"><div class="nav-link" style="text-decoration: none;" onmouseover="this.style.color='#fff';" onmouseout="this.style.color='#fff';">{{Auth::user()->name}}</div></li><!-- END Offsidebar menu-->
            <li class="nav-item"><a class="nav-link" href="{{URL::to('/')}}/admin/logout" data-toggle-state="offsidebar-open" data-no-persist="true"><em class="icon-notebook"></em></a></li><!-- END Offsidebar menu-->
        </ul><!-- END Right Navbar-->
        <!-- START Search form-->
